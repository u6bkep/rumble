...
fn render_about() -> El {
    ...
    let describe = env!("RUMBLE_DAMASCENE_GIT_DESCRIBE");
    let short_hash = env!("RUMBLE_DAMASCENE_GIT_SHORT_HASH");
    let full_hash = env!("RUMBLE_DAMASCENE_GIT_HASH");
    let tag = env!("RUMBLE_DAMASCENE_GIT_TAG");
    let dirty = env!("RUMBLE_DAMASCENE_GIT_DIRTY") == "true";
