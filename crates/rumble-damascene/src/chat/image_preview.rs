...
/// by the next one. Fed to damascene's `redraw_within` on animated
...
/// rendered natively by damascene at any size.
#[derive(Clone, Debug)]
...
/// damascene client (png/jpg/jpeg/gif/webp/bmp/ico/tif/tiff).
