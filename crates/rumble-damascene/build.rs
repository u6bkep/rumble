...
fn main() {
    ...
    println!("cargo:rustc-env=RUMBLE_DAMASCENE_GIT_DESCRIBE={describe}");
    println!("cargo:rustc-env=RUMBLE_DAMASCENE_GIT_HASH={hash}");
    println!("cargo:rustc-env=RUMBLE_DAMASCENE_GIT_SHORT_HASH={short_hash}");
    println!("cargo:rustc-env=RUMBLE_DAMASCENE_GIT_TAG={tag}");
    println!(
        "cargo:rustc-env=RUMBLE_DAMASCENE_GIT_DIRTY={}",
