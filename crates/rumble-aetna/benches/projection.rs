...
//!
//! Run: `cargo bench -p rumble-aetna --bench projection`
//!
//! The client redraws ~30×/sec even when idle (a known workaround for aetna
...
//! window. The golden snapshots in `crates/rumble-aetna/goldens/` are the
//! behavior net for this path; this bench is the cost net.
//!
//! Baseline-gated workflow:
//!   cargo bench -p rumble-aetna --bench projection -- --save-baseline before
//!   # ... optimize ...
//!   cargo bench -p rumble-aetna --bench projection -- --baseline before

use std::hint::black_box;

use aetna_core::prelude::*;
use criterion::{BenchmarkId, Criterion, criterion_group};
use rumble_aetna::{Identity, RumbleApp, backend::UiBackend};
use rumble_client::{
